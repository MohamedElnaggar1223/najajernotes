...
export default function EditUserForm({ user })
{
    ...
    const onActiveChanged = e => setActive(prevState => !prevState)
    ...
    let canSave
    if(password && !validPassword) canSave = [roles.length, validUsername, validPassword].every(Boolean) && !isLoading
